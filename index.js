...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Dark\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=556196333905:+55 619633-3905\n' //Nomor whatsapp kamu
            + 'END:VCARD'
			...
			const mod = [ownerNumber,"//gif					
				...
				case 'lolifig':
                   ...
                   if (!isGroup) return reply(mess.only.group)
					...
					awat limitAdd(sender) @s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556196333905@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556196333905@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556196333905@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
// recursos anime, random @dark domina vida
          ...
          reply('Espere..')
				...
				case 'neko':
					...
					dark.sendMess(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT QHNK ✨* 」\n*│+ wa.me/556196333905*╰──────*「 *DARK* 」*────*\n\n*_SE QUER SER ADMIN DO BOT DARK_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
